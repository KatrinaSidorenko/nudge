...
public static class MediatRExtensions
{
    ...
    {
        // Handlers, DTOs, validators and endpoints all live in Nudge (LearningRoot's assembly)
        // now; this assembly (Nudge.Api) is scanned too in case an endpoint-side pipeline
